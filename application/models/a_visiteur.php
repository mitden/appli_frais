...
class A_visiteur extends CI_Model {
	...
	*/
	...
	{	// TODO : Contrôler que toutes les valeurs de $unMois sont valides (chaine de caractère dans la BdD)
		...
		$this->templates->load('t_base_visiteur', 'visiteur/v_visAccueil');
	}
	...
	*/
	...
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
		...
		$this->templates->load('t_base_visiteur', 'visiteur/v_visMesFiches', $data);	
	}	
	...
	*/
	...
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
		...
		$this->templates->load('t_base_visiteur', 'visiteur/v_visVoirListeFrais', $data);
	}
	...
	*/
	...
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
		...
		$this->templates->load('t_base_visiteur', 'visiteur/v_visModListeFrais', $data);
	}
